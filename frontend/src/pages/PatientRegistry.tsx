...
export const PatientRegistry: React.FC = () => {
    ...
    const getSamplePatients = (): Patient[] => [
        ...
        { patient_id: 6, trial_patient_id: 'PT-00128', date_of_birth: '1995-01-17', gender: 'F', patient_status: 'Screened', enrollment_date: '2024-01-16', institution_name: 'Site 102' },
    ];
                    ...
                    <table className="data-table">
                        ...
                        <tbody>
                            {filteredPatients.map((patient) => (
                                /* Use patient.patient_id for key */
